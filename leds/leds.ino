...
PololuLedStrip<2> computerStrip;
PololuLedStrip<5> ebenchStrip;
PololuLedStrip<6> workbenchStrip;
...
void loop()
{
  ...
  computerStrip.write(colors, LED_COUNT);
  ebenchStrip.write(colors, LED_COUNT);
  workbenchStrip.write(colors, LED_COUNT);
